const contractAddress = "0x2058AA9450A1e7eafD19D20b60e4a804AaE19d83"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the JHart Watchers NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The JHart Watchers NFT Project is the first series to be released by JHart, a young digital artist!  Each piece is hand-drawn and unique; not digitally randomized or generated.  This limited set from the Watchers series is an opportunity for JHart to share their art with the greater world in the exciting new NFT space.  If you are not familiar with purchasing NFTs, helpful links have been included below:';
